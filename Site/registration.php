...
ob_start();
    ...
    if(isset($_POST['submit'])){
        ...
        $test = "SELECT * from users where name = '$username'";
...
<div class="signup-form">
    <form action="registration.php" method="POST">
		<h2>Εγγραφή</h2>
		<p class="hint-text">Δημιουργία λογαριασμού.</p>
		...
		<div class="form-group">
            <button type="submit"  id="register" name="submit" class="btn btn-success btn-lg btn-block">Εγγραφή τώρα</button>
        </div>
    </form>
	<div class="text-center">Έχεις ήδη λογαριασμό; <a href="login.php">Συνδέση</a></div>
</div>
<!-- Modal HTML -->
