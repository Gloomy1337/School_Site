...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
    ...
    foreach ($_SESSION["cart_array"] as $each_item) { 
		...
		$cartOutput .= "<tr>";
		$cartOutput .= '<td><a href="product.php?id=' . $item_id . '">' . $product_name . '</a><br /><img src="store/test' . $item_id . '.jpg" alt="' . $product_name. '" width="40" height="52" border="1" /></td>';
...
<br />
 ...
 <div class="row">
  <div class="col-75">
    <div class="container">
      <form action="confirmBuy.php" method="GET">
    ...
    <div class="container">
      <h4>Cart
        <span class="price" style="color:black">
          ...
          <div><div style='font-size:18px; margin-top:12px;' align='right'><?php echo $cartTotal; ?> $</div>
        </span>
      </h4>
    </div>
  </div>
